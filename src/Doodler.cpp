 ...
 * 
 * DESCRIPTION:
 * Implementation of the Doodler (player character) class with physics
 * simulation including velocity management, position updates, and
 * collision-based jump mechanics. Handles keyboard input, sprite rendering,
 * and exception handling for resource loading.
 * 
 ...
 * - Physics Engine: Gravity (dy += 0.2), velocity tracking
 * - Virtual Functions: Overrides draw(), getPosition(), setPosition()
 * - Exception Handling: Try-catch for file loading with custom exceptions
 * - Composition: Contains Keyboard object for input management
 * - Encapsulation: Private velocity (dy) with controlled access
 * ====================================================================
 */
